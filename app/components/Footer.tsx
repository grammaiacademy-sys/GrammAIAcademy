      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-medium">RestorePro</span>
              </div>
              
              <p className="text-gray-300 mb-6 max-w-md">
                <span>AI-powered smart search for Xactimate line items. Built by restoration professionals, for restoration professionals.</span>
              </p>
        ...
        >
          <p className="text-gray-400 text-sm mb-4 sm:mb-0">
            <span>© {currentYear} RestorePro. All rights reserved.</span>
          </p>
