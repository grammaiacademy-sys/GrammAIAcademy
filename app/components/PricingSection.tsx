...
export default function PricingSection() {
  ...
  const { checkout, loading: paymentLoading } = useCosmicPayments();

  const features = [
    'AI-powered smart search',
    '30,000+ Xactimate line items',
    'Water, Fire, Mold, Rebuild categories',
  ...
  const handleGetStarted = async () => {
    ...
    // In a real app, you&apos;d have actual product IDs from your Cosmic dashboard
    const mockProductId = billingCycle === 'monthly' ? 'prod_monthly_plan' : 'prod_annual_plan';
    const mockPriceId = billingCycle === 'monthly' ? 'price_monthly_10' : 'price_annual_120';
  ...
  return (
    <section id="pricing" className="py-24 bg-gradient-to-br from-blue-50 to-white" ref={ref}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600 mb-8">
            <span>Choose the plan that works best for you. No hidden fees, no surprises.</span>
          </p>
        ...
        >
          ...
          {billingCycle === 'annual' && (
            ...
            >
              <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-2 rounded-full text-sm font-medium shadow-lg">
                <span>🎉 Best Value - Lifetime Access!</span>
              </div>
            </motion.div>
          )}
            ...
            <div className="relative z-10">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-medium text-gray-900 mb-2">
                  <span>RestorePro {billingCycle === 'annual' ? 'Lifetime' : 'Monthly'}</span>
                </h3>
                ...
                {billingCycle === 'annual' && (
                  ...
                  >
                    <span>Pay once, use forever! No recurring charges.</span>
                  </motion.div>
                )}
